...
mytiny0 = fit(
     ...
     data = Data,
     dsem = dsem,
     data_colnames = list(variable="Species", time="Year", spatial="Region", distribution="Species"),
     family_link = rbind( "chum" = c(1,1),
                          "pink" = c(1,1),
                          "sockeye" = c(1,1) ),
     spatial_graph = unconnected_graph,
     control = tinyVASTcontrol( trace=0, profile="alpha_j", getsd=FALSE ) )
