...
In either case, $\mu_{\PL 1,i}$ is the $\mathrm{Pr}(Y>0)$ (and is fitted with a Bernoulli distribution), while $\mu_{\PL 2,i}$ is the central tendancy for positive values, i.e., $\mathbb{E}(Y | Y>0) = \mu_{\PL 2,i}$.
