...
EVAL <- has_fmesher && has_lattice && has_pdp
...
null = fit( data = Data, formula = n ~ 1,
...
```{r, eval=TRUE, echo=TRUE, message=FALSE, fig.width=6, fig.height=6}
out_reduced = fit( data = Data, formula = n ~ s(w),
                   control = tinyVASTcontrol(quiet=TRUE, trace=0), sem = "" )
