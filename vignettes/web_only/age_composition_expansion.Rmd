...
#> Error in array(N_jz$Biomass, dim = c(length(myfit$internal$variables), : 'data' must be of a vector type, was 'NULL'
N_ct = N_ct / outer( rep(1,nrow(N_ct)), colSums(N_ct) )
#> Error: object 'N_ct' not found
```
...
#> Error: object 'longtiny' not found
