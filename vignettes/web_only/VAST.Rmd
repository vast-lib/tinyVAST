...
We next highlight how to specify a bivariate spatio-temporal model with a cross-laggged (vector autoregressive) interaction [@thorson_estimating_2017,@thorson_spatio-temporal_2019].  We first simulate artificial data for the sake of demonstration:
