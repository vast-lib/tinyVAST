...
We can then calculate the area-weighted total abundance by supplying a `newdata` object that has rows for each area in the domain.  Here however we show a simpler sample-weighted index:
