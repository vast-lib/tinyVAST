...
```{r stream-shape, eval=TRUE, echo=TRUE, message=FALSE, fig.width=6, fig.height=6, warning=FALSE}
...
```{r stream-dens, eval=TRUE, echo=TRUE, message=FALSE, fig.width=6, fig.height=6}
# Plot stream
plot(stream)
...
```{r stream-pred, eval=TRUE, echo=TRUE, message=FALSE, fig.width=6, fig.height=6}
# fit model
