...
We here explore the capacity to specify a generalized linear latent variable model that is configured to generalize an empirical orthogonal function analysis [@thorson_defining_2020].
...
```{r EOF, eval=TRUE, echo=TRUE, message=FALSE, fig.width=6, fig.height=6}
