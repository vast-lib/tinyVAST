...
function( formula,
  ...
  tmb_data = list(
    ...
    t_i = as.integer(t_i - 1), # -1 to convert to CPP index, and keep as integer-vector
    c_i = as.integer(c_i - 1), # -1 to convert to CPP index, and keep as integer-vector
    ...
    e_i = as.integer(distributions$e_i - 1), # -1 to convert to CPP index, and keep as integer-vector
