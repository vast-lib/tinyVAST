...
simultaneous effects in multivariate spatio-temporal models. Global
Ecology and Biogeography. 34(4): e70035.
...
the same models as `tinyVAST` in an approximate Bayesian inference
framework.
